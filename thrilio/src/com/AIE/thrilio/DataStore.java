...
// Array DataStorage kind of database of real world
import com.AIE.thrilio.constant.BookGenre;
import com.AIE.thrilio.constant.Gender;
...
public class DataStore {
	...
	private static void loadWebLinks() {
		...
		bookmarks[0][3] = BookmarkManager.getInstance().createWebLink(2003, "NIO tutorial by Greg Travis", "hhttp://cs.brown.edu/courses/cs161/papers/j-nio-ltr.pdf", "http://cs.brown.edu");
	...
	private static void loadMovies() {
		...
		bookmarks[1][2] = BookmarkManager.getInstance().createMovie(3002,"Citizen Kane","",1941,new String[]{"Orson Welles","Joseph Cotten"},new String[]{"Orson Welles"},MovieGenre.CLASSICS,8.5);
		bookmarks[1][3] = BookmarkManager.getInstance().createMovie(3003,"Citizen Kane","",1941,new String[]{"Orson Welles","Joseph Cotten"},new String[]{"Orson Welles"},MovieGenre.CLASSICS,8.5);
		bookmarks[1][4] = BookmarkManager.getInstance().createMovie(3004,"Citizen Kane","",1941,new String[]{"Orson Welles","Joseph Cotten"},new String[]{"Orson Welles"},MovieGenre.CLASSICS,8.5);	
